...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        //creating bar chart
        var $barData  = [
            { y: '2017, in %', a: 28, b: 25 , c: 4, d: 2, e: 1, f: 1 }
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c', 'd', 'e', 'f'],
                            ['Aktien, Fonds', 'Immobilien', 'Gold, Edelmetalle', 'Bausparvertrag', 'Sparbuch', 'Tagesgeld'], ["#ffd760", "#f76397", "#68b1ff", "#00b19d", "#f96161", "#c4c4c4"]);
